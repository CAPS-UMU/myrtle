...
import whatDoYouThinkGraph as wdyt
...
def main():
    ...
    y_col = "Kernel Time"
    title = f"{input[7:-4]}"
    titleOfWebpage = "What do you think?"
    # --- Step 1: Read the CSV file ---
    ...
    html = wdyt.generateInteractiveGraphs(df, title, titleOfWebpage, shapeMetric,cmFeatures, coeffs, features, df_w_prediction)
