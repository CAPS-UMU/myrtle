...
python padding-graph.py "$FOLDER/review-cube.csv" "padding-naive/Cube256x256x256-svr" "" "" "256x256x256" ""
python padding-graph.py "$FOLDER/512x512x512wm-n-k_distillbert-results.csv" "padding-naive/Cube512x512x512-svr" "" "" "512x512x512" ""

python padding-graph.py "$FOLDER/128x128x128wm-n-k_top10_l1.csv" "padding-naive/Cube128x128x128-svr" "" "" "128x128x128" "$FOLDER/128x128x128wm-n-k_searchSpace_c_analyzed-untimed.csv"
