echo "Generating graphs for SELECTED RUNS of dispatches 7, and 8 using mode $1..."
mode="$1"
user="hoppip"
user="emily"
here=$(pwd)
...
#. graphing-reruns.sh svrcyc

pwd 
python3 -m graphing.deliverableGraphs "SEGFAULT_DEBUGGING" $mode
cd $here
